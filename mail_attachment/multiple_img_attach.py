...
import imghdr   #to read the type of an image
...
images=['pic1.jpg','pic2.jpg','pic3.jpg']   #list of picture that need to be attached

for image in images:
    with open(image,'rb') as f:      #file handling   and .jpg is mandatory
